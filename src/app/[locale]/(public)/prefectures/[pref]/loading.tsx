...
export default function PrefectureLoading() {
  return (
    <PublicRouteLoadingShell>
      {/* Hero 骨架 */}
      <section className="relative shrink-0 pt-32 pb-32 overflow-hidden bg-gray-800 md:pt-40">
      ...
      {/* Ceramic 区域骨架 */}
      <section className="relative z-30 px-6 shrink-0">
      ...
      {/* 主内容网格骨架 */}
      <section className="relative z-30 pb-24 px-6 pt-20 shrink-0">
