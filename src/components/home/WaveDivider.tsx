...
type Props = {
  ...
  isRotated?: boolean;
  withTexture?: boolean;
  textureSize?: number; // 原图尺寸，默认 120
  textureDensityX?: number; // 横向纹理密度，用于抵消拉伸感
};
...
const WaveDivider = ({
  ...
  return (
    <div
      className={`
        absolute left-0 w-full overflow-hidden leading-none z-20 pointer-events-none
        top-[-1px]
    ...
    >
      ...
      >
        ...
        <use href="#wave-paths" className={fill} />
